...
int main()
{
   ...
   // DUT instantiation
   CicIntegrator< INPUT_TYPE, OUTPUT_TYPE > cic_integrator_0( "cic_integrator_0" );
   ...
   // DUT instantiation
   CicIntegrator< INPUT_TYPE, OUTPUT_TYPE > cic_integrator_1( "cic_integrator_1" );
   ...
   // DUT instantiation
   CicIntegrator< INPUT_TYPE, OUTPUT_TYPE > cic_integrator_2( "cic_integrator_2" );
   ...
   // DUT instantiation
   CicIntegrator< INPUT_TYPE, OUTPUT_TYPE > cic_integrator_3( "cic_integrator_3" );
   ...
   CicDifferentiator< INPUT_TYPE, OUTPUT_TYPE > cic_differentiator_0( "cic_diff_0" );
   ...
   CicDifferentiator< INPUT_TYPE, OUTPUT_TYPE > cic_differentiator_1( "cic_diff_1" );
   ...
   CicDifferentiator< INPUT_TYPE, OUTPUT_TYPE > cic_differentiator_2( "cic_diff_2" );
